...
public class ResultSetMetaDataDemoRefactored {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Display all metadata and data using separate methods
            printTableInformation(metaData);
            printColumnDetails(metaData);
            printActualData(resultSet, metaData);
    ...
    /**
     * Prints table information from ResultSetMetaData
     */
    private static void printTableInformation(ResultSetMetaData metaData) throws SQLException {
    ...
    /**
     * Prints column details in a formatted table
     */
    ...
    /**
     * Prints the actual data from the ResultSet
     */
    private static void printActualData(ResultSet resultSet, ResultSetMetaData metaData) throws SQLException {
        int columnCount = metaData.getColumnCount();
    ...
    /**
     * Prints additional metadata information for each column
     */
