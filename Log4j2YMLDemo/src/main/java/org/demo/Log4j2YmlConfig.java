...
//Program is not working as expected as of now.
// need to work on this to resolve error
public class Log4j2YmlConfig {
    private static Logger logger = LogManager.getLogger(Log4j2YmlConfig.class);
    public static void main(String[] args) {
        System.out.println("=== Log4j2YmlConfig ===");
